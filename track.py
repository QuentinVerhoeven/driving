...
def main():
    ...
    parser.add_argument("--conf", type=float, default=0.5)  # min detection confidence to keep a box; raised from 0.3 -> 0.5 after testing, which roughly halved ID flicker (197 -> 109 unique IDs on clip1) by dropping borderline low-confidence detections
